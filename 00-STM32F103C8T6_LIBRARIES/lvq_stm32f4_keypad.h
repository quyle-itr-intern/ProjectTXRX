...
typedef enum {
    ...
    LVQ_KEYPAD_Button_STAR = 0x0A,                  /*!< Button START code */
    LVQ_KEYPAD_Button_HASH = 0x0B,                  /*!< Button HASH code */
    LVQ_KEYPAD_Button_A = 0x0C,                     /*!< Button A code. Only on large size */
    LVQ_KEYPAD_Button_B = 0x0D,                     /*!< Button B code. Only on large size */
    LVQ_KEYPAD_Button_C = 0x0E,                     /*!< Button C code. Only on large size */
    LVQ_KEYPAD_Button_D = 0x0F,                     /*!< Button D code. Only on large size */

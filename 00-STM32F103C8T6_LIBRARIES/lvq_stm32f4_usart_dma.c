...
#ifdef USE_USART1
static LVQ_USART_DMA_INT_t USART1_DMA_INT = {USART1_DMA_TX_CHANNEL, USART1_DMA_TX_STREAM};
#endif
#ifdef USE_USART2
static LVQ_USART_DMA_INT_t USART2_DMA_INT = {USART2_DMA_TX_CHANNEL, USART2_DMA_TX_STREAM};
#endif
#ifdef USE_USART3
static LVQ_USART_DMA_INT_t USART3_DMA_INT = {USART3_DMA_TX_CHANNEL, USART3_DMA_TX_STREAM};
#endif
#ifdef USE_UART4
static LVQ_USART_DMA_INT_t UART4_DMA_INT = {UART4_DMA_TX_CHANNEL, UART4_DMA_TX_STREAM};
#endif
#ifdef USE_UART5
static LVQ_USART_DMA_INT_t UART5_DMA_INT = {UART5_DMA_TX_CHANNEL, UART5_DMA_TX_STREAM};
#endif
#ifdef USE_USART6
static LVQ_USART_DMA_INT_t USART6_DMA_INT = {USART6_DMA_TX_CHANNEL, USART6_DMA_TX_STREAM};
#endif
#ifdef USE_UART7
static LVQ_USART_DMA_INT_t UART7_DMA_INT = {UART7_DMA_TX_CHANNEL, UART7_DMA_TX_STREAM};
#endif
#ifdef USE_UART8
static LVQ_USART_DMA_INT_t UART8_DMA_INT = {UART8_DMA_TX_CHANNEL, UART8_DMA_TX_STREAM};
#endif
...
/* Private functions */
static LVQ_USART_DMA_INT_t* LVQ_USART_DMA_INT_GetSettings(USART_TypeDef* USARTx);
...
void LVQ_USART_DMA_Init(USART_TypeDef* USARTx) 
{
    ...
    /* Clear flags */
    LVQ_DMA_ClearFlags(USART_Settings->DMA_Stream);
...
{
    /* Get USART settings */
    return LVQ_USART_DMA_INT_GetSettings(USARTx)->DMA_Stream;
}

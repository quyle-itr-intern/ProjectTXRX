...
typedef struct {
		USART_TypeDef* USART_MODBUS_RTU;
		uint32_t Baudrate_MODBUS_RTU;
		GPIO_TypeDef* GPIO_Port_MODBUS_RTU_EN;
		uint16_t GPIO_Pin_MODBUS_RTU_EN;
} LVQ_MODBUS_RTU_Info_t;

/**
 * @brief  Init modbus rtu RS485
 * @param  Baudrate modbus rtu, pin enable rx/tx
 * @retval None
 */

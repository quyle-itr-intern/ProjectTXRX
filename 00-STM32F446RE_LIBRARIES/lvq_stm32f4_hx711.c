...
#include "lvq_stm32f4_hx711.h"

void LVQ_HX711_Init(void)
{
		/* Define clock pin */
		LVQ_GPIO_Init(LVQ_HX711_CLOCK_GPIO, LVQ_HX711_CLOCK_PIN, LVQ_GPIO_Mode_OUT, LVQ_GPIO_OType_PP, LVQ_GPIO_PuPd_NOPULL, LVQ_GPIO_Speed_High);
		
		/* Define data pin */
		LVQ_GPIO_Init(LVQ_HX711_DATA_GPIO, LVQ_HX711_DATA_PIN, LVQ_GPIO_Mode_IN, LVQ_GPIO_OType_PP, LVQ_GPIO_PuPd_NOPULL, LVQ_GPIO_Speed_High);

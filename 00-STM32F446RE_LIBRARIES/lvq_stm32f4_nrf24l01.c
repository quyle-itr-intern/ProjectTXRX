...
#include "lvq_stm32f4_nrf24l01.h"
...
uint8_t NRF24L01_CHECK_BIT(reg, bit)       { return (reg & (1 << bit)) == 0  ? 0 : 1; }
...
void LVQ_NRF24L01_PrintDetail(void)
{
		uint8_t RX[5];
		LVQ_NRF24L01_ReadRegisterMulti(NRF24L01_REG_TX_ADDR, RX, 5);
		printf("TX_ADDR : 0x%x " , RX[0]);
		printf("0x%x " , RX[1]);
		printf("0x%x " , RX[2]);
		printf("0x%x " , RX[3]);
		printf("0x%x\r\n" , RX[4]);
		
		LVQ_NRF24L01_ReadRegisterMulti(NRF24L01_REG_RX_ADDR_P0, RX, 5);

		printf("RX_ADDR_P0 : 0x%x " , RX[0]);
		printf("0x%x " , RX[1]);
		printf("0x%x " , RX[2]);
		printf("0x%x " , RX[3]);
		printf("0x%x\r\n" , RX[4]);
	
		LVQ_NRF24L01_ReadRegisterMulti(NRF24L01_REG_RX_ADDR_P1, RX, 5);

		printf("RX_ADDR_P1 : 0x%x " , RX[0]);
		printf("0x%x " , RX[1]);
		printf("0x%x " , RX[2]);
		printf("0x%x " , RX[3]);
		printf("0x%x\r\n" , RX[4]);
		
		LVQ_NRF24L01_WriteRegister(NRF24L01_REG_CONFIG, 0x0E);
		LVQ_NRF24L01_WriteRegister(NRF24L01_REG_RF_SETUP, 0x21);

		printf("EN_AA: 0x%x\r\n", LVQ_NRF24L01_ReadRegister(NRF24L01_REG_EN_AA));
		printf("EN_RXADDR: 0x%x\r\n", LVQ_NRF24L01_ReadRegister(NRF24L01_REG_EN_RXADDR));
		printf("RF_CH: 0x%x\r\n", LVQ_NRF24L01_ReadRegister(NRF24L01_REG_RF_CH));
		printf("RF_SETUP: 0x%x\r\n", LVQ_NRF24L01_ReadRegister(NRF24L01_REG_RF_SETUP));
		printf("CONFIG : 0x%x\r\n", LVQ_NRF24L01_ReadRegister(NRF24L01_REG_CONFIG));
		printf("DYNPD: 0x%x\r\n", LVQ_NRF24L01_ReadRegister(NRF24L01_REG_DYNPD));
		printf("FEATURE: 0x%x\r\n", LVQ_NRF24L01_ReadRegister(NRF24L01_REG_FEATURE));
}

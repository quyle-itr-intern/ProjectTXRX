...
/* Private variables */
#ifdef SPI1
static LVQ_SPI_DMA_INT_t SPI1_DMA_INT = {SPI1_DMA_TX_CHANNEL, SPI1_DMA_TX_STREAM, SPI1_DMA_RX_CHANNEL, SPI1_DMA_RX_STREAM};
#endif
#ifdef SPI2
static LVQ_SPI_DMA_INT_t SPI2_DMA_INT = {SPI2_DMA_TX_CHANNEL, SPI2_DMA_TX_STREAM, SPI2_DMA_RX_CHANNEL, SPI2_DMA_RX_STREAM};
#endif
#ifdef SPI3
static LVQ_SPI_DMA_INT_t SPI3_DMA_INT = {SPI3_DMA_TX_CHANNEL, SPI3_DMA_TX_STREAM, SPI3_DMA_RX_CHANNEL, SPI3_DMA_RX_STREAM};
#endif
#ifdef SPI4
static LVQ_SPI_DMA_INT_t SPI4_DMA_INT = {SPI4_DMA_TX_CHANNEL, SPI4_DMA_TX_STREAM, SPI4_DMA_RX_CHANNEL, SPI4_DMA_RX_STREAM};
#endif
#ifdef SPI5
static LVQ_SPI_DMA_INT_t SPI5_DMA_INT = {SPI5_DMA_TX_CHANNEL, SPI5_DMA_TX_STREAM, SPI5_DMA_RX_CHANNEL, SPI5_DMA_RX_STREAM};
#endif
#ifdef SPI6
static LVQ_SPI_DMA_INT_t SPI6_DMA_INT = {SPI6_DMA_TX_CHANNEL, SPI6_DMA_TX_STREAM, SPI6_DMA_RX_CHANNEL, SPI6_DMA_RX_STREAM};
#endif
...
/* Private functions */
static LVQ_SPI_DMA_INT_t* LVQ_SPI_DMA_INT_GetSettings(SPI_TypeDef* SPIx);
...
void LVQ_SPI_DMA_Init(SPI_TypeDef* SPIx) 
{
    ...
    /* Get USART settings */
    LVQ_SPI_DMA_INT_t* Settings = LVQ_SPI_DMA_INT_GetSettings(SPIx);
...
uint8_t LVQ_SPI_DMA_Transmit(SPI_TypeDef* SPIx, uint8_t* TX_Buffer, uint8_t* RX_Buffer, uint16_t count) 
{
    ...
    LVQ_DMA_ClearFlag(Settings->TX_Stream, DMA_FLAG_ALL);
    ...
    LVQ_DMA_ClearFlag(Settings->RX_Stream, DMA_FLAG_ALL);
...
DMA_Stream_TypeDef* LVQ_SPI_DMA_GetStreamTX(SPI_TypeDef* SPIx) 
{
    ...
    return LVQ_SPI_DMA_INT_GetSettings(SPIx)->TX_Stream;
}

DMA_Stream_TypeDef* LVQ_SPI_DMA_GetStreamRX(SPI_TypeDef* SPIx) 
{
    /* Return pointer to TX stream */
    return LVQ_SPI_DMA_INT_GetSettings(SPIx)->RX_Stream;
}
...
void LVQ_SPI_DMA_EnableInterrupts(SPI_TypeDef* SPIx) 
{
    ...
    LVQ_DMA_EnableInterrupts(Settings->TX_Stream);
    LVQ_DMA_EnableInterrupts(Settings->RX_Stream);
}
...
void LVQ_SPI_DMA_DisableInterrupts(SPI_TypeDef* SPIx) 
{
    ...
    /* Enable interrupts for TX and RX streams */
    LVQ_DMA_DisableInterrupts(Settings->TX_Stream);
    LVQ_DMA_DisableInterrupts(Settings->RX_Stream);
}

/* Private functions */
static LVQ_SPI_DMA_INT_t* LVQ_SPI_DMA_INT_GetSettings(SPI_TypeDef* SPIx) 
{
    LVQ_SPI_DMA_INT_t* result;
#ifdef SPI1
    if (SPIx == SPI1) {
        result = &SPI1_DMA_INT;
    }

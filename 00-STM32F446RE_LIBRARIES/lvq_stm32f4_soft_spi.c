...
#include "lvq_stm32f4_soft_spi.h"
...
{
		LVQ_GPIO_Init(sspi.SMOSIPort, sspi.SMOSIPin, LVQ_GPIO_Mode_OUT, LVQ_GPIO_OType_PP, LVQ_GPIO_PuPd_NOPULL, LVQ_GPIO_Speed_High);
		LVQ_GPIO_Init(sspi.SMISOPort, sspi.SMISOPin, LVQ_GPIO_Mode_IN, LVQ_GPIO_OType_PP, LVQ_GPIO_PuPd_NOPULL, LVQ_GPIO_Speed_High);
		LVQ_GPIO_Init(sspi.SSCKPort, sspi.SSCKPin, LVQ_GPIO_Mode_OUT, LVQ_GPIO_OType_PP, LVQ_GPIO_PuPd_NOPULL, LVQ_GPIO_Speed_High);
		LVQ_GPIO_Init(sspi.NSSPort, sspi.NSSPin, LVQ_GPIO_Mode_OUT, LVQ_GPIO_OType_PP, LVQ_GPIO_PuPd_NOPULL, LVQ_GPIO_Speed_High);
